...
public class MusicExchangeTestProgram {
    public static void main(String args[]) {
        ...
        System.out.println("Available Songs: " + mec.allAvailableSongs() + "\n"); // Attempt to log on two registered
                                                                                  // users and one unregistered user
                                                                                  // discoStew.logon(mec);
                                                                                  // sleepingSam.logon(mec); // Should
                                                                                  // not work ronnieRocker.logon(mec);
                                                                                  // System.out.println("Status: " +
                                                                                  // mec); System.out.println("On-Line
                                                                                  // Users: " + mec.onlineUsers());
                                                                                  // System.out.println("Available
                                                                                  // Songs: " + mec.allAvailableSongs()
                                                                                  ...
                                                                                  // System.out.println("Available
                                                                                  // Songs: " +
                                                                                  // mec.allAvailableSongs());
                                                                                  // System.out.println("Available Songs
                                                                                  // By Jaw: " +
                                                                                  // mec.availableSongsByArtist("Jaw") +
                                                                                  // "\n"); // Log off three users (one
                                                                                  ...
                                                                                  // By Jaw: " +
                                                                                  // mec.availableSongsByArtist("Jaw") +
                                                                                  // "\n"); // Log off the last two
                                                                                  // users peterPunk.logoff(mec);
